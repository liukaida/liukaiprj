...
;(function(exports){
	var KeyBoard = function(input, options){
		...
		var btnStr2 = '<div style="width:60px;height:28px;background-color:#1FB9FF;';
		btnStr2 += 'float:right;margin-right:5px;text-align:center;color:#fff;';
		btnStr2 += 'line-height:28px;border-radius:3px;margin-bottom:5px;cursor:pointer;">清空</div>';
		...
		var tableStr = '<table id="' + TABLE_ID + '" border="0" cellspacing="0" cellpadding="0">';
			...
			tableStr += '</table>';
		this.el.innerHTML = cssStr + btnStr + btnStr2 + tableStr;

...
# from apps.pypinyin import pinyin_dict
from apps.pypinyin.pinyin_dict import pinyin_dict
from apps.pypinyin.compat import SUPPORT_UCS4

# 词语拼音库
if os.environ.get('PYPINYIN_NO_PHRASES'):
    PHRASES_DICT = {}
else:
    # from apps.pypinyin import phrases_dict
    from apps.pypinyin.phrases_dict import phrases_dict

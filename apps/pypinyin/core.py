...
from apps.pypinyin.compat import text_type, callable_check
from apps.pypinyin.constants import (
    PHRASES_DICT, PINYIN_DICT,
    RE_HANS, Style
)
from apps.pypinyin.contrib import mmseg
from apps.pypinyin.utils import simple_seg, _replace_tone2_style_dict_to_default
from apps.pypinyin.style import auto_discover, convert as convert_style
